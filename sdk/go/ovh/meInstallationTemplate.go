...
func (o MeInstallationTemplateOutput) AvailableLanguages() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *MeInstallationTemplate) pulumi.StringArrayOutput { return v.AvailableLanguages }).(pulumi.StringArrayOutput)
}
...
func (o MeInstallationTemplateOutput) Beta() pulumi.BoolOutput {
	return o.ApplyT(func(v *MeInstallationTemplate) pulumi.BoolOutput { return v.Beta }).(pulumi.BoolOutput)
}

// This template bit format (32 or 64)
func (o MeInstallationTemplateOutput) BitFormat() pulumi.IntOutput {
	return o.ApplyT(func(v *MeInstallationTemplate) pulumi.IntOutput { return v.BitFormat }).(pulumi.IntOutput)
}
...
func (o MeInstallationTemplateOutput) DefaultLanguage() pulumi.StringOutput {
	return o.ApplyT(func(v *MeInstallationTemplate) pulumi.StringOutput { return v.DefaultLanguage }).(pulumi.StringOutput)
}

// is this distribution deprecated
func (o MeInstallationTemplateOutput) Deprecated() pulumi.BoolOutput {
	return o.ApplyT(func(v *MeInstallationTemplate) pulumi.BoolOutput { return v.Deprecated }).(pulumi.BoolOutput)
}
...
func (o MeInstallationTemplateOutput) LastModification() pulumi.StringOutput {
	return o.ApplyT(func(v *MeInstallationTemplate) pulumi.StringOutput { return v.LastModification }).(pulumi.StringOutput)
}
...
func (o MeInstallationTemplateOutput) SupportsDistributionKernel() pulumi.BoolOutput {
	return o.ApplyT(func(v *MeInstallationTemplate) pulumi.BoolOutput { return v.SupportsDistributionKernel }).(pulumi.BoolOutput)
}

// This distribution supports the GUID Partition Table (GPT), providing up to 128 partitions that can have more than 2TB
func (o MeInstallationTemplateOutput) SupportsGptLabel() pulumi.BoolOutput {
	return o.ApplyT(func(v *MeInstallationTemplate) pulumi.BoolOutput { return v.SupportsGptLabel }).(pulumi.BoolOutput)
}

// This distribution supports RTM software
func (o MeInstallationTemplateOutput) SupportsRtm() pulumi.BoolOutput {
	return o.ApplyT(func(v *MeInstallationTemplate) pulumi.BoolOutput { return v.SupportsRtm }).(pulumi.BoolOutput)
}

// This distribution supports the microsoft SQL server
func (o MeInstallationTemplateOutput) SupportsSqlServer() pulumi.BoolOutput {
	return o.ApplyT(func(v *MeInstallationTemplate) pulumi.BoolOutput { return v.SupportsSqlServer }).(pulumi.BoolOutput)
}

// This distribution supports UEFI setup (no,only,yes)
func (o MeInstallationTemplateOutput) SupportsUefi() pulumi.StringOutput {
	return o.ApplyT(func(v *MeInstallationTemplate) pulumi.StringOutput { return v.SupportsUefi }).(pulumi.StringOutput)
}
