...
__all__ = [
    ...
    'get_ip_load_balancing_v_rack_network',
    'get_ip_load_balancing_v_rack_network_output',
]
...
def get_ip_load_balancing_v_rack_network(service_name: Optional[str] = None,
    ...
    lb_network = ovh.get_ip_load_balancing_v_rack_network(service_name="XXXXXX",
...
@_utilities.lift_output_func(get_ip_load_balancing_v_rack_network)
def get_ip_load_balancing_v_rack_network_output(service_name: Optional[pulumi.Input[str]] = None,
