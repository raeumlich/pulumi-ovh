...
__all__ = [
    ...
    'get_ip_load_balancing_v_rack_networks',
    'get_ip_load_balancing_v_rack_networks_output',
]
...
def get_ip_load_balancing_v_rack_networks(service_name: Optional[str] = None,
    ...
    lb_networks = ovh.get_ip_load_balancing_v_rack_networks(service_name="XXXXXX",
        subnet="10.0.0.0/24")
    ```
...
@_utilities.lift_output_func(get_ip_load_balancing_v_rack_networks)
def get_ip_load_balancing_v_rack_networks_output(service_name: Optional[pulumi.Input[str]] = None,
