...
__all__ = [
    ...
    'GetProductCartProductPlanPriceResult',
    'GetProductCartProductPlanPricePriceResult',
    'GetProductCartProductPlanSelectedPriceResult',
    'GetProductCartProductPlanSelectedPricePriceResult',
]
...
@pulumi.output_type
class GetProductCartProductPlanPriceResult(dict):
    def __init__(__self__, *,
                 capacities: Sequence[Any],
                 description: str,
                 duration: str,
                 ...
                 minimum_repeat: int,
                 price_in_ucents: int,
                 prices: Sequence['outputs.GetProductCartProductPlanPricePriceResult'],
                 pricing_mode: str,
                 pricing_type: str):
        """
        :param Sequence[Any] capacities: Capacities of the pricing (type of pricing)
        ...
        :param int minimum_repeat: Minimum repeat for renewal
        :param int price_in_ucents: Price of the product in micro-centims
        :param Sequence['GetProductCartProductPlanPricePriceArgs'] prices: Price of the product (Price with its currency and textual representation)
        :param str pricing_mode: Pricing model identifier
        :param str pricing_type: Pricing type
        """
        pulumi.set(__self__, "capacities", capacities)
    ...
    @property
    @pulumi.getter
    def prices(self) -> Sequence['outputs.GetProductCartProductPlanPricePriceResult']:
        """
        Price of the product (Price with its currency and textual representation)
        """
        return pulumi.get(self, "prices")
...
@pulumi.output_type
class GetProductCartProductPlanPricePriceResult(dict):
    def __init__(__self__, *,
                 currency_code: str,
                 text: str,
                 value: float):
...
@pulumi.output_type
class GetProductCartProductPlanSelectedPriceResult(dict):
    def __init__(__self__, *,
                 capacities: Sequence[Any],
                 description: str,
                 duration: str,
                 ...
                 minimum_repeat: int,
                 price_in_ucents: int,
                 prices: Sequence['outputs.GetProductCartProductPlanSelectedPricePriceResult'],
                 pricing_mode: str,
                 pricing_type: str):
        """
        :param Sequence[Any] capacities: Capacities of the pricing (type of pricing)
        ...
        :param int minimum_repeat: Minimum repeat for renewal
        :param int price_in_ucents: Price of the product in micro-centims
        :param Sequence['GetProductCartProductPlanSelectedPricePriceArgs'] prices: Price of the product (Price with its currency and textual representation)
        :param str pricing_mode: Pricing model identifier
        :param str pricing_type: Pricing type
        """
        pulumi.set(__self__, "capacities", capacities)
    ...
    @property
    @pulumi.getter
    def prices(self) -> Sequence['outputs.GetProductCartProductPlanSelectedPricePriceResult']:
        """
        Price of the product (Price with its currency and textual representation)
        """
        return pulumi.get(self, "prices")
...
@pulumi.output_type
class GetProductCartProductPlanSelectedPricePriceResult(dict):
    def __init__(__self__, *,
                 currency_code: str,
                 text: str,
                 value: float):
