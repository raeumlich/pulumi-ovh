...
__all__ = [
    'GetCloudProjectFailoverIPAttachResult',
    'AwaitableGetCloudProjectFailoverIPAttachResult',
    'get_cloud_project_failover_ip_attach',
    'get_cloud_project_failover_ip_attach_output',
]

@pulumi.output_type
class GetCloudProjectFailoverIPAttachResult:
    """
...
class AwaitableGetCloudProjectFailoverIPAttachResult(GetCloudProjectFailoverIPAttachResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCloudProjectFailoverIPAttachResult(
            block=self.block,
...
def get_cloud_project_failover_ip_attach(block: Optional[str] = None,
                                         continent_code: Optional[str] = None,
                                         geo_loc: Optional[str] = None,
                                         ip: Optional[str] = None,
                                         routed_to: Optional[str] = None,
                                         service_name: Optional[str] = None,
                                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCloudProjectFailoverIPAttachResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ovh:index/getCloudProjectFailoverIPAttach:getCloudProjectFailoverIPAttach', __args__, opts=opts, typ=GetCloudProjectFailoverIPAttachResult).value

    return AwaitableGetCloudProjectFailoverIPAttachResult(
        block=__ret__.block,
...
@_utilities.lift_output_func(get_cloud_project_failover_ip_attach)
def get_cloud_project_failover_ip_attach_output(block: Optional[pulumi.Input[Optional[str]]] = None,
                                                ...
                                                opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetCloudProjectFailoverIPAttachResult]:
    """
    Use this data source to get the details of a failover ip address of a service in a public cloud project.
