...
__all__ = [
    ...
    'get_cloud_project_container_registry_users',
    'get_cloud_project_container_registry_users_output',
]
...
def get_cloud_project_container_registry_users(registry_id: Optional[str] = None,
    ...
    registry = ovh.get_cloud_project_containerregistry(service_name="XXXXXX",
        registry_id="yyyy")
...
@_utilities.lift_output_func(get_cloud_project_container_registry_users)
