...
__all__ = [
    ...
    'get_d_baa_s_logs_output_graylog_stream',
    'get_d_baa_s_logs_output_graylog_stream_output',
]
...
def get_d_baa_s_logs_output_graylog_stream(service_name: Optional[str] = None,
    ...
    stream = ovh.get_d_baa_s_logs_output_graylog_stream(service_name="XXXXXX",
        title="my stream")
    ```
...
@_utilities.lift_output_func(get_d_baa_s_logs_output_graylog_stream)
def get_d_baa_s_logs_output_graylog_stream_output(service_name: Optional[pulumi.Input[str]] = None,
