...
class IPLoadBalancingTCPFarmServerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] address: Address of the backend server (IP from either internal or OVH network)
        ...
        :param pulumi.Input[str] proxy_protocol_version: version of the PROXY protocol used to pass origin connection information from loadbalancer to recieving service (`v1`, `v2`, `v2-ssl`, `v2-ssl-cn`)
...
class IPLoadBalancingTCPFarmServer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        lb = ovh.get_ip_load_balancing(service_name="ip-1.2.3.4",
            state="ok")
