...
__all__ = [
    'GetProductCartProductPlanResult',
    'AwaitableGetProductCartProductPlanResult',
    'get_product_cart_product_plan',
    'get_product_cart_product_plan_output',
]

@pulumi.output_type
class GetProductCartProductPlanResult:
    """
    ...
    @property
    @pulumi.getter
    def prices(self) -> Sequence['outputs.GetProductCartProductPlanPriceResult']:
        """
    ...
    def selected_prices(self) -> Sequence['outputs.GetProductCartProductPlanSelectedPriceResult']:
        """
...
class AwaitableGetProductCartProductPlanResult(GetProductCartProductPlanResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetProductCartProductPlanResult(
...
def get_product_cart_product_plan(cart_id: Optional[str] = None,
                                  catalog_name: Optional[str] = None,
                                  plan_code: Optional[str] = None,
                                  price_capacity: Optional[str] = None,
                                  product: Optional[str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetProductCartProductPlanResult:
    """
    ...
    mycart = ovh.get_order_cart(ovh_subsidiary="fr",
        description="my cart")
    plan = ovh.get_product_cart_product_plan(cart_id=mycart.id,
    ...
    __ret__ = pulumi.runtime.invoke('ovh:index/getProductCartProductPlan:getProductCartProductPlan', __args__, opts=opts, typ=GetProductCartProductPlanResult).value

    return AwaitableGetProductCartProductPlanResult(
...
@_utilities.lift_output_func(get_product_cart_product_plan)
def get_product_cart_product_plan_output(cart_id: Optional[pulumi.Input[str]] = None,
                                         ...
                                         opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetProductCartProductPlanResult]:
    """
    Use this data source to retrieve information of order cart product plan.
