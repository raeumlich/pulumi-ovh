...
export interface GetProductCartProductPlanPrice {
    /**
     * Capacities of the pricing (type of pricing)
     */
    capacities: any[];
     ...
     * Price of the product (Price with its currency and textual representation)
     */
    prices: outputs.GetProductCartProductPlanPricePrice[];
    /**
     * Pricing model identifier
     */
    pricingMode: string;
...
export interface GetProductCartProductPlanPricePrice {
    /**
     * Currency code
     */
    currencyCode: string;
...
export interface GetProductCartProductPlanSelectedPrice {
    /**
     * Capacities of the pricing (type of pricing)
     */
    capacities: any[];
     ...
     * Price of the product (Price with its currency and textual representation)
     */
    prices: outputs.GetProductCartProductPlanSelectedPricePrice[];
    /**
     * Pricing model identifier
     */
    pricingMode: string;
...
export interface GetProductCartProductPlanSelectedPricePrice {
    /**
     * Currency code
     */
    currencyCode: string;
