...
namespace Pulumi.Ovh
{
    public static class GetIPLoadBalancing
    {
        ...
        public static Task<GetIPLoadBalancingResult> InvokeAsync(GetIPLoadBalancingArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIPLoadBalancingResult>("ovh:index/getIPLoadBalancing:getIPLoadBalancing", args ?? new GetIPLoadBalancingArgs(), options.WithDefaults());
        ...
        public static Output<GetIPLoadBalancingResult> Invoke(GetIPLoadBalancingInvokeArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetIPLoadBalancingResult>("ovh:index/getIPLoadBalancing:getIPLoadBalancing", args ?? new GetIPLoadBalancingInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetIPLoadBalancingInvokeArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        /// the name displayed in ManagerV6 for your iplb (max 50 chars)
        /// </summary>
