...
namespace Pulumi.Ovh
{
    public static class GetDedicatedServer
    {
        ...
        public static Task<GetDedicatedServerResult> InvokeAsync(GetDedicatedServerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDedicatedServerResult>("ovh:index/getDedicatedServer:getDedicatedServer", args ?? new GetDedicatedServerArgs(), options.WithDefaults());
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Output<GetDedicatedServerResult> Invoke(GetDedicatedServerInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetDedicatedServerResult>("ovh:index/getDedicatedServer:getDedicatedServer", args ?? new GetDedicatedServerInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetDedicatedServerInvokeArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        /// The service_name of your dedicated server.
        /// </summary>
        ...
        public GetDedicatedServerInvokeArgs()
        {
        }
    }
