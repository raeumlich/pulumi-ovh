...
namespace Pulumi.Ovh
{
    public static class GetOrderCartProductOptionsPlan
    {
        ...
        ///             Description = "my cart",
        ///         }));
        ///         var plan = mycart.Apply(mycart =&gt; Output.Create(Ovh.GetOrderCartProductOptionsPlan.InvokeAsync(new Ovh.GetOrderCartProductOptionsPlanArgs
        ///         {
        ///             CartId = mycart.Id,
        ///             PriceCapacity = "renew",
        ///             Product = "cloud",
    ...
    public sealed class GetOrderCartProductOptionsPlanInvokeArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        /// Cart identifier
        /// </summary>
